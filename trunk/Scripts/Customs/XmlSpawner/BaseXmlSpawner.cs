                            ...
                            else if (kw == valuemodKeyword.GETONNEARBY)
                            {
                                ...
                                if (value_keywordargs.Length > 3)
                                {
                                    ...
                                    if (no_error)
                                    {
                                        ...
                                        ArrayList nearbylist = GetNearbyObjects(relativeto, targetname, targettype, typestr, range, searchcontainers, null);
                    ...
                    case typeKeyword.BSOUND:
                        {
                            ...
                            if (arglist.Length > 0)
                            {
                                ...
                                if (keywordargs.Length > 1)
                                {
                                    ...
                                    catch { status_str = "invalid soundid arg to BSOUND"; }
                                }
