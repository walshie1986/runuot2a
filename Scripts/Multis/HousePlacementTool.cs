		...
		private static HousePlacementEntry[] m_ClassicHouses = new HousePlacementEntry[]
			{
				...
				new HousePlacementEntry( typeof( GuildHouse ),			1011309,	1100,	685,	1576,	788,	28,	131500,	   	-1,	7,	0,	0x0074	),
				...
				new HousePlacementEntry( typeof( LargePatioHouse ),		1011315,	1100,	685,	1576,	788,	28,	129250,	   	-4,	7,	0,	0x008C	),
