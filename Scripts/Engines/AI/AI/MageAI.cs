...
namespace Server.Mobiles
{
	public class MageAI : BaseAI
	{
		...
		public override bool DoActionCombat()
		{
			...
			if ( m_Mobile.Skills[SkillName.Magery].Value >= 10.0 && (m_Mobile.Controlled || m_Mobile.Summoned || m_Mobile.IsParagon || m_Mobile.Aggressors.Count > 0 || m_Mobile.FindLeastRecentDamageEntry(false) != null ) && m_Mobile.Spell == null && DateTime.Now > m_NextCastTime && m_Mobile.InRange( c, 12 ) )
			{
