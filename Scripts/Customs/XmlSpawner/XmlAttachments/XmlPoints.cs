...
namespace Server.Engines.XmlSpawner2
{
	...
	public class XmlPoints : XmlAttachment
	{
		...
		public static bool LogKills = false;			// log all kills that award points to the kills.log file
				...
				if(targeted is Mobile && ((Mobile)targeted).Player)
				{
					...
					if(a != null && !a.Deleted)
					{
						...
						if(a.Challenger != null)
						{
							...
							{
								// timer is running
								a.SendText(100208, a.m_CancelEnd - DateTime.Now); // "{0} mins remaining until current challenge is cancelled."
							} 
							else
							{
