...
public static void _TraceEnd(int index)
{
	   if(index < MaxTraces){
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register("XmlSpawnerRespawn", AccessLevel.GameMaster, new CommandEventHandler(Respawn_OnCommand));
            CommandSystem.Register("XmlSpawnerRespawnAll", AccessLevel.GameMaster, new CommandEventHandler(RespawnAll_OnCommand));
